...
export const CLIENT_APP_URL = required("CLIENT_APP_URL", "http://localhost:5000");
export const SHORT_URL_BASE_URL = required(
  "SHORT_URL_BASE_URL",
  `http://localhost:${PORT}`,
);

export const INVITATION_EXPIRES_IN = process.env.INVITATION_EXPIRES_IN ?? "7d" as const;
